...
VIAddVersionKey /LANG=${LANG_PORTUGUESE} "FileVersion" "1.0.0"
VIAddVersionKey /LANG=${LANG_PORTUGUESE} "ProductVersion" "1.0.0"
...
Section "Instalar"
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\My Business.lnk" "$INSTDIR\my_business.exe"
    CreateShortcut "$SMPROGRAMS\$StartMenuFolder\Desinstalar.lnk" "$INSTDIR\uninstall.exe"
  !insertmacro MUI_STARTMENU_WRITE_END

  ; Criar atalho na Área de Trabalho
  CreateShortcut "$DESKTOP\My Business.lnk" "$INSTDIR\my_business.exe"
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\My Business" "DisplayIcon" "$INSTDIR\my_business.exe"
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\My Business" "DisplayVersion" "1.0.0"
