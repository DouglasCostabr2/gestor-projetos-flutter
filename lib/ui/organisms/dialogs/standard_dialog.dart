...
class StandardDialog extends StatelessWidget {
  ...
  /// Se true, usa layout customizado para actions (não envolve em Row)
  /// Útil quando actions contém uma Column ou estrutura complexa
  final bool customActionsLayout;
  ...
  const StandardDialog({
    ...
    required this.child,
    this.actions,
    this.customActionsLayout = false,
              ...
              children: [
                ...
                if (actions != null && actions!.isNotEmpty)
                  Container(
                    ...
                    child: customActionsLayout
                        ? actions!.first // Se customActionsLayout=true, renderiza o primeiro widget diretamente
                        : Row(
